...
#if defined(NDEBUG)
# error "BloomBitcoin cannot be compiled without assertions."
#endif
...
uint256 hashGenesisBlock("0x11ac1ee649b60a8d059ca8a91a4cf7291814ae6c8d70c820bf6e3254694c29eb");
static CBigNum bnProofOfWorkLimit(~uint256(0) >> 1); // BloomBitcoin: starting difficulty is 1 / 2^1000000000000
...
const string strMessageMagic = "BloomBitcoin Signed Message:\n";
...
{
    // BloomBitcoin: IsDust() detection disabled, allows any valid dust to be relayed.
...
int64 static GetBlockValue(int nHeight, int64 nFees)
{
    ...
    // Subsidy is cut to zero after 1 block, which will occur in premine
    nSubsidy >>= (nHeight / 4); // BloomBitcoin: 1000000000 coins in first block

    return nSubsidy + nFees;
}

static const int64 nTargetTimespan = 30 * 24 * 60 * 60; // BloomBitcoin: 30 days
static const int64 nTargetSpacing = 1 * 1; // BloomBitcoin: 1 second
...
unsigned int static GetNextWorkRequired(const CBlockIndex* pindexLast, const CBlockHeader *pblock)
{
    ...
    // BloomBitcoin: This fixes an issue where a 51% attack can change difficulty at will.
...
bool CBlock::CheckBlock(CValidationState &state, bool fCheckPOW, bool fCheckMerkleRoot) const
{
    ...
    // BloomBitcoin: Special short-term limits to avoid 10,000 BDB lock limit:
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x11ac1ee649b60a8d059ca8a91a4cf7291814ae6c8d70c820bf6e3254694c29eb");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        //     CTxIn(COutPoint(0000000000, -1), coinbase 04ffff001d0104404e592054696d65732030352f4f63742f32305301905374657665204a6f62732c204170706c65e280997320566973696f6e6172792c2044696573206174203536)
        //     CTxOut(nValue=50.00000000, scriptPubKey=040184710fa689ad5023690c80f3a4)
        //   vMerkleTree: 97ddfbbae6

        // Genesis block
        const char* pszTimestamp = "The Times Of India 10 Oct 2017: Trump's rashness threatens WWIII";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        txNew.vin[0].scriptSig = CScript() << 486604799 << CBigNum(4) << vector<unsigned char>((const unsigned char*)pszTimestamp, (const unsigned char*)pszTimestamp + strlen(pszTimestamp));
        txNew.vout[0].nValue = 50 * COIN;
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("0402f4710fa689ad5023690c80f3a49c8f13f8d45b8c857fbcbc8bc4a8e4d3eb4b10f4d4604fa08dce601aaf0f470216fe1b51850b4acf21b179c45070ac7b04b6") << OP_CHECKSIG;
        CBlock block;
        block.vtx.push_back(txNew);
        block.hashPrevBlock = 0;
        block.hashMerkleRoot = block.BuildMerkleTree();
        block.nVersion = 1;
        block.nTime    = 1507647835;
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 2852197;
        ...
        assert(block.hashMerkleRoot == uint256("0x4acaea5c4211e5d26d97c900f5fa0921677229f47fc550e903466f568ecc11c1"));
...
unsigned char pchMessageStart[4] = { 0xd1, 0xc3, 0xb2, 0xbd }; // BloomBitcoin: increase each by adding 2 to bitcoin's value.
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("BloomBitcoinMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("BloomBitcoinMiner : ProcessBlock, block not accepted");
    }

    return true;
}

void static BloomBitcoinMiner(CWallet *pwallet)
{
    printf("BloomBitcoinMiner started\n");
    SetThreadPriority(THREAD_PRIORITY_LOWEST);
    RenameThread("bloombitcoin-miner");
    ...
    try { loop {
        ...
        printf("Running BloomBitcoinMiner with %"PRIszu" transactions in block (%u bytes)\n", pblock->vtx.size(),
    ...
    {
        printf("BloomBitcoinMiner terminated\n");
        throw;
    }
}
...
void GenerateBitcoins(bool fGenerate, CWallet* pwallet)
{
    ...
    for (int i = 0; i < nThreads; i++)
        minerThreads->create_thread(boost::bind(&BloomBitcoinMiner, pwallet));
}
