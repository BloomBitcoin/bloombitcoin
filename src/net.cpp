...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "BloomBitcoin " + FormatFullVersion();
        ...
        try {
            loop {
                ...
                MilliSleep(2*60*1000); // Refresh every 2 minutes
            }
        }
...
static const char *strMainNetDNSSeed[][2] = {
    {"bloombitcointools.com", "52.192.242.199"},
    {NULL, NULL}
};

static const char *strTestNetDNSSeed[][2] = {
    {"bloombitcointools.com", "testnet-seed.bloombitcointools.com"},
    {"xurious.com", "testnet-seed.bbcx.xurious.com"},
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. BloomBitcoin is probably already running."), addrBind.ToString().c_str());
        else
